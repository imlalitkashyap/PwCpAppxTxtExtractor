...
API_ID = int(os.environ.get("API_ID", 26640133))
API_HASH = os.environ.get("API_HASH", "20f7033d806073ac2f4582e52e351d2e")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8163799328:AAFmQD8rjTR604BlX7nyEWyUT6pmPiCvXGA")
